...
#
    ...
    if test_period > 0:
        ...
        data_loader_val=makeFashionDataLoader(cfg,val_dataset)
    else:
        # 直接使用训练集
        data_loader=makeFashionDataLoader(cfg,dataset)
...
def run_test(cfg, model, distributed):
    ...
    data_loader_val=makeFashionDataLoader(cfg,dataset)
    # data_loader_val = DataLoader(dataset,batch_size=args.batch_size)
